...
# Test token address (SOL/USDC pool on Raydium)
TEST_TOKEN_ADDRESS = "58oQChx4yWmvKdwLLZzBi4ChoCc2fqCUWBkwMihLYQo2"
...
async def test_rpc_connection():
    ...
    try:
        ...
        slot = await rpc.client.get_slot()
        logger.info(f"Connected successfully. Current slot: {slot}")
        return True
